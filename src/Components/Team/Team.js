...
const Team = () => {
    return (
        ...
        <div className = 'body'>
            ...
            <div class="p-4">
                <p class="text-center text-3xl font-bold color">
                    Professional team
                </p>
                ...
                <div class="flex items-center flex-col md:flex-row justify evenly">
                    <div class="p-4 relative">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2 imgBox">
                            <a href="#" class="block relative">
                                <img alt="profil" src="https://i.ibb.co/vvSsRQ9/hanif.png" />
                            </a>
                        </div>
                    ...
                    <div class="p-4 relative secondDiv">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2 imgBox">
                            <a href="#" class="block relative">
                                <img alt="profil" src="https://i.ibb.co/mSBKf1F/1621415116498.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800" />
                            </a>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
                            <div class="text-center">
                    ...
                    <div class="p-4 relative secondDiv">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2 imgBox">
                            <a href="#" class="block relative">
                                <img alt="profil" src="https://i.ibb.co/qM8Bz8C/190559096-312441237166701-7160339082037164244-n.png" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800" />
                            </a>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
                            <div class="text-center">
